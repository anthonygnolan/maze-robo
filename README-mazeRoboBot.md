...
3. Give the bot a handle (ex: `mazeRoboBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://mazerobo.azurewebsites.net/api/messages`
